...
type Order struct {
	...
	Status          string    `gorm:"type:enum('pending','processing','completed','cancelled');default:'pending'" json:"status"`
...
type OrderItem struct {
	...
	Status          string    `gorm:"type:enum('pending','processing','shipped','delivered','cancelled');default:'pending'" json:"status"`
	CreatedAt       time.Time `json:"created_at"`
	UpdatedAt       time.Time `json:"updated_at"`
